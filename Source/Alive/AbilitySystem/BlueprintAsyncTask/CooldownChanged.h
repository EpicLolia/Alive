...
#include "CooldownChanged.generated.h"
...
class ALIVE_API UCooldownChanged : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static UCooldownChanged* ListenForCooldownChange(UAbilitySystemComponent* AbilitySystemComponent,
