...
#include "EffectStackChanged.generated.h"
...
/**
 * Blueprint node to automatically register a listener for changes to a GameplayEffect's stack count
 * based on an Asset or Granted tag on the Effect. Useful to use in UI.
 */
UCLASS(BlueprintType, meta = (ExposedAsyncProxy = AsyncTask))
class ALIVE_API UEffectStackChanged : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
	...
	static UEffectStackChanged* ListenForGameplayEffectStackChange(
		UAbilitySystemComponent* AbilitySystemComponent, FGameplayTag EffectGameplayTag);
