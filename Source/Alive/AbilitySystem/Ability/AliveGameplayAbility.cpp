...
const FGameplayTagContainer* UAliveGameplayAbility::GetCooldownTags() const
{
...
void UAliveGameplayAbility::ApplyCooldown(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo,
