...
#include "AbilitySystem/Ability/GameplayAbilityTargetData_GenerateProjectile.h"
#include "Components/ActorComponent.h"
#include "ProjectileComponent.generated.h"

struct ALIVE_API FProjectileInstance
{
	FProjectileInstance(uint16 Key, const FVector& Location = FVector(), const FVector& Direction = FVector())
		: ProjectileID(Key), CurrentLocation(Location), InitDirection(Direction), ElapsedTime(0.0f), bPendingKill(false)
	{
...
public:
	...
	void FireOneProjectile(const FGameplayAbilityTargetData* TargetData);
protected:
